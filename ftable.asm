...
.jtext  .CSEG AT FLASH_TABLE                    ; Vector Name            Vector Address Relocated Vector Address
        ...
        .DB4    0xffffffff	                ; INTP0                         ;0x0008 ;0x0010
        .DB4    0xffffffff                      ; INTP1                         ;0x000A ;0x0014
        .DB4    0xffffffff	                ; INTP2                         ;0x000C ;0x0018
         BR     !!_r_intc3_interrupt            ; INTP3                         ;0x000E ;0x001C
        .DB4    0xffffffff	                ; INTP4                         ;0x0010 ;0x0020
        ...
        .DB4    0xffffffff                      ; INTDMA1                       ;0x001C ;0x0038
         BR     !!_r_uart0_interrupt_send       ; INTCSI00/INTIIC00/INTST0      ;0x001E ;0x003C
         BR     !!_r_uart0_interrupt_receive    ; INTSR0                        ;0x0020 ;0x0040
        ...
        .DB4    0xffffffff                      ; INTSRE1/INTTM03H              ;0x0028 ;0x0050
        .DB4    0xffffffff                      ; INTIICA0                      ;0x002A ;0x0054
         BR     !!_r_tau0_channel0_interrupt    ; INTTM00                       ;0x002C ;0x0058
        .DB4    0xffffffff			; INTTM01                       ;0x002E ;0x005C
        .DB4    0xffffffff                      ; INTTM02                       ;0x0030 ;0x0060
        .DB4    0xffffffff                      ; INTTM03                       ;0x0032 ;0x0064
        .DB4    0xffffffff                      ; INTAD                         ;0x0034 ;0x0068
         BR     !!_r_rtc_interrupt              ; INTRTC                        ;0x0036 ;0x006C
         BR     !!_r_it_interrupt               ; INTIT                         ;0x0038 ;0x0070
         BR     !!_r_key_interrupt              ; INTKR	                        ;0x003A ;0x0074
        .DB4    0xffffffff                      ; Reserved                      ;0x003C ;0x0078
        .DB4    0xffffffff                      ; Reserved                      ;0x003E ;0x007C
        .DB4    0xffffffff                      ; Reserved                      ;0x0040 ;0x0080
        .DB4    0xffffffff                      ; INTTM04                       ;0x0042 ;0x0084

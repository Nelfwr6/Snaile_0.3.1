...
extern uint8_t MQTT_PUB_SUCC_FLAG,MQTT_PUB_SUCC_FLAG1,MQTT_OPEN_FLAG,MQTT_STAT_FAIL,MQT_PDP_RECONNECT_FLAG,MQTT_PUB_FAIL_FLAG,\
MQTT_PDP_FAIL_FLAG,MQTT_PUB_RETRY_FLAG,MQT_RECONNECT_FLAG,Reconnect_flag,MQTT_SUB_SUCC_FLAG,MQTT_CONN_SUCCESS_FLAG;
